...
# CSS universale: elimina lo scroll e colora i pulsanti in base alla colonna (Rosso / Verde)
st.markdown("""
<style>
 ...
 /* Stile per il riquadro rettangolare con bordo che sostituisce l'immagine */
