...
# CSS universale: elimina lo scroll, adatta le proporzioni a 100vh e gestisce i pulsanti
st.markdown("""
<style>
 /* Blocca la pagina all'altezza dello schermo dello smartphone eliminando lo scroll */
 ...
 /* Riduce i padding di Streamlit e distribuisce lo spazio in verticale */
 ...
 /* Compatta i testi per risparmiare pixel preziosi su schermi corti */
 h3 {
 ...
 /* Forza le colonne a rimanere affiancate in orizzontale anche su mobile stretto */
 ...
 /* Stile base per tutti i pulsanti dell'applicazione */
 div.stButton > button {
 width: 100% !important;
 height: 42px !important; /* Altezza ridotta e proporzionata */
 ...
 /* NAVBAR SUPERIORE: Pulsanti Indietro e Reset (Grigio/Neutro senza sfondo) */
 ...
 /* ZONE DECISIONALI IN BASSO: Colonna 1 (NO / ASSENTE / ALTRO) -> Rosso */
 div[data-testid="stHorizontalBlock"]:not(:nth-of-type(1)) div[data-testid="column"]:nth-of-type(1) button {
 background-color: #e74c3c !important;
 color: white !important;
 border: none !important;
 }

 /* ZONE DECISIONALI IN BASSO: Colonna 2 (SI / PRESENTE / CONFERMA) -> Verde */
 div[data-testid="stHorizontalBlock"]:not(:nth-of-type(1)) div[data-testid="column"]:nth-of-type(2) button {
 background-color: #2ecc71 !important;
 color: white !important;
 border: none !important;
 }

 /* Riquadro surrogato dell'immagine ad altezza percentuale dinamica */
 .box-immagine-surrogato {
 width: 100%;
 height: 18vh !important; /* Si adatta proporzionalmente all'altezza del telefono */
...
# -------------------------------------------------------------------------
if mp != "risultato":
 # Forza il posizionamento in alto a sinistra dei comandi Indietro e Reset
